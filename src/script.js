...
TIDAK.addEventListener('click', () => {
    ...
    document.querySelector('.wrapper > div > img').setAttribute('src','Asset/22b0da421086d344420bcc7fb45598b1.png')
});
IYA.addEventListener('click', () => {
    ...
    document.querySelector('.wrapper > div > img').setAttribute('src','Asset/bcb2a8115cc9610a0c1a9d78ccb9a051.png')
});